...
win_team_log_path = os.path.join("C:", os.sep, "output", "edit", "boss_killed_log", "win_participant_log.csv")
TWENTY_MINUTE_SECONDS = 1200

with open(win_team_log_path, 'w') as csv_f:

    # 項目名の出力
    csv_f.write("game_id,team_id,key,win_flag,total_time\n")
    ...
    for file_index, json_file_path in enumerate(json_files_path):
        ...
        with open(json_file_path, 'r') as f:
            ...
            for participant in json_data['participants']:
                ...
                tmp_str = '{game_id},{team_id},{key},{win_flag},{total_time}\n' .format(game_id=game_id, \
